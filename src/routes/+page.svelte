	...
	>
		...
		<div class="hero-intro mx-auto flex w-full max-w-3xl flex-col items-center text-center">
			...
			<h1
				...
				class="title-shimmer mb-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl"
			>
				Lan Lebar
			</h1>
			{#key i18n.locale}
			...
			<div
				class="flex w-xs flex-col items-stretch justify-center gap-3 sm:w-auto sm:flex-row sm:flex-wrap"
				id="links-container"
			>
				<a
					use:shine
		...
		<button
			...
			class="btn-shine pill-shine absolute! bottom-4 mx-auto hidden h-12 w-12 animate-bounce cursor-pointer items-center justify-center rounded-full border border-zinc-700 bg-zinc-900/70 text-zinc-400 shadow-sm backdrop-blur transition-colors hover:border-zinc-400 hover:bg-zinc-800 hover:text-zinc-100 sm:flex"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="24"
