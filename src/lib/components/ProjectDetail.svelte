...
<div class="relative overflow-hidden">
	...
	<div class="relative mx-auto w-full max-w-4xl px-6 py-12 sm:px-8 sm:py-16">
		...
		<a href="/"
			class="mb-10 inline-flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-950/80 px-4 py-3 text-sm font-medium text-zinc-200 transition hover:-translate-y-0.5 hover:border-zinc-500 hover:text-white"
		>
			...
			<div class="flex flex-wrap items-center gap-3">
				...
				{:else if link}
					...
					<a href={link}
						target="_blank"
						rel="noopener noreferrer"
						class="inline-flex items-center gap-2 rounded-xl border border-zinc-500 bg-zinc-100 px-5 py-3 text-sm font-semibold text-zinc-900 shadow transition hover:-translate-y-0.5 hover:bg-white"
					>
				...
				{#if github}
					...
					<a href={github}
						target="_blank"
						rel="noopener noreferrer"
						class="inline-flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-950/80 px-5 py-3 text-sm font-medium text-zinc-200 transition hover:-translate-y-0.5 hover:border-zinc-500 hover:bg-zinc-800 hover:text-white"
					>
		...
		<section class="detail-fade mb-12 sm:mb-16" style="animation-delay: 100ms">
			<h2 class="mb-5 text-2xl font-bold text-white">{m.project_page_overview()}</h2>
		...
		<section class="detail-fade mb-12 sm:mb-16" style="animation-delay: 200ms">
			<h2 class="mb-6 text-2xl font-bold text-white">{m.project_page_features()}</h2>
			<ul class="space-y-6">
