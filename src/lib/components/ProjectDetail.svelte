	...
	<div class="relative mx-auto w-full max-w-4xl px-6 py-12 sm:px-8 sm:py-16">
		...
		<header class="detail-fade mb-12 sm:mb-16">
			...
			<div class="flex flex-wrap items-center gap-3">
				...
				{:else if link}
					<!-- eslint-disable-next-line svelte/no-navigation-without-resolve -->
					<a use:shine href={link} target="_blank" rel="noopener noreferrer" class={actionButtonClass}>
				...
				{#if github}
					<!-- eslint-disable-next-line svelte/no-navigation-without-resolve -->
					<a use:shine href={github} target="_blank" rel="noopener noreferrer" class={actionButtonClass}>
